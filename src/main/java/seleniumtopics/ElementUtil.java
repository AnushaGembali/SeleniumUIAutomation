...
public class ElementUtil {
	...
	public void doSendKeys(By locator, String value, int time) {
		doGetElementAfterVisisble(locator,time).sendKeys(value);
	}
...
//		 		.perform();
	  ...
	  * @return
	  */
	 public WebElement doGetElementAfterVisisble(By locator, int time) {
		 WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(time));
	  ...
	  * @return
	  */
	 public List<WebElement> doGetElementsAfterVisisble(By locator, int time) {
		 WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(time));
